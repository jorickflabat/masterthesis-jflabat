...
class SlotTable(object):
    ...
    def add_node(self, node_id, resourcetuple, storages=[], running_vms=0, hostname=""):
        ...
        """        
        self.nodes[node_id] = Node(resourcetuple, storages, running_vms, hostname)
...
class Node(object):
    ...
    def __init__(self, capacity, storages=[], running_vms=0, hostname=""):
        """Constructor
